...
import SingleCasesPage from "../components/app_components/CasesPage/SingleCasesPage";
import CaseProjectLayoutPage from "../components/app_components/CasesPage/CaseProjectLayoutPage";
//  ~cb-add-import~
    ...
    return (
        <Routes>
            ...
            <Route path="/project" exact element={<DashboardAdminControl />} />
                ...
                // myapp
<Route path="/cases/:singleCasesId" exact element={<SingleCasesPage />} />
<Route path="/cases" exact element={<CaseProjectLayoutPage />} />
